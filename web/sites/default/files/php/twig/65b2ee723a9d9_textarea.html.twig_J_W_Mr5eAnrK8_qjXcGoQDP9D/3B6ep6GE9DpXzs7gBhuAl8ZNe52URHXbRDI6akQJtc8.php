...
class __TwigTemplate_9bd22853c05f4e03e8a2c1c06109e9e9 extends Template
{
    private $source;
    private $macros = [];
...
($context["required"] ?? null)) ? ("required") : (""))];
        // line 24
        echo "<div";
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["wrapper_attributes"] ?? null), "addClass", ["form-textarea-wrapper"], "method", false, false, true, 24), 24, $this->source), "html", null, true);
        echo ">
  <textarea";
        // line 25
...
";
    ...
    {
        return new Source("", "themes/contrib/bootstrap_barrio/templates/form/textarea.html.twig", "C:\\xampp\\htdocs\\web_bits\\web\\themes\\contrib\\bootstrap_barrio\\templates\\form\\textarea.html.twig");
    }

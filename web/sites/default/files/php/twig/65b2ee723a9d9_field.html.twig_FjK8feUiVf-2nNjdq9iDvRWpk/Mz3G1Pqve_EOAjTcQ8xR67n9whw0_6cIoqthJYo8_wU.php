...
class __TwigTemplate_a34f74aafc2c49ef0d960d97fe31619d extends Template
{
    private $source;
    private $macros = [];
...
";
  ...
  ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    // line 64
                    echo "      <div";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [($context["classes"] ?? null), "field__item"], "method", false, false, true, 64), 64, $this->source), "html", null, true);
                    echo ">";
...
";
    ...
    {
        return new Source("", "themes/contrib/bootstrap_barrio/templates/field/field.html.twig", "C:\\xampp\\htdocs\\web_bits\\web\\themes\\contrib\\bootstrap_barrio\\templates\\field\\field.html.twig");
    }
